defmodule KsuidTest do
  ...
  test "parse max timestamp" do
    encoding = Base62.encode(<<255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255>>)

    {:ok, time, data } = Ksuid.parse(encoding)
    assert time == %DateTime{calendar: Calendar.ISO, day: 19, hour: 23, microsecond: {0, 0},
    minute: 21, month: 6, second: 35, std_offset: 0, time_zone: "Etc/UTC",
    utc_offset: 0, year: 2150, zone_abbr: "UTC"}
    assert data === <<255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255>>
  end
